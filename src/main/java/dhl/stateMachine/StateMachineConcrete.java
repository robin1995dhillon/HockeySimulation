...
import dhl.stateMachine.gameSimulationAlgorithm.*;
...
public class StateMachineConcrete extends StateMachineAbstractFactory{
    ...
    private ITime leagueTimeConcept;

    public StateMachineConcrete() {
    }

    @Override
    public ITime getLeagueTimeConcept() {
        if(leagueTimeConcept == null) {
            leagueTimeConcept = new LeagueTimeConcept();
        }
        return leagueTimeConcept;
    }

    @Override
    public void setLeagueTimeConcept(ITime leagueTimeConcept) {
        this.leagueTimeConcept = leagueTimeConcept;
    }
